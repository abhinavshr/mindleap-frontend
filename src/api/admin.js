...
export const banUser = (id) => adminApi.post(`/admin/users/ban/${id}`);

export const unbanUser = (id) => adminApi.post(`/admin/users/unban/${id}`);
...
export const deleteAdmin = (id) => adminApi.delete(`/admin/remove/${id}`);
...
export const fetchAdminProfile = () => adminApi.get("/admin/profile");

export const fetchWords = (page = 1, limit = 100, search = "", config) =>
  adminApi.get("/admin/words/list", {
    params: { page, limit, search },
    ...config,
  });

export const addWord = (word) => adminApi.post("/admin/words/add", { word });

export const editWord = (id, { word, is_used }) =>
  adminApi.put(`/admin/words/edit/${id}`, { word, is_used });

export const deleteWord = (id) => adminApi.delete(`/admin/words/delete/${id}`);
