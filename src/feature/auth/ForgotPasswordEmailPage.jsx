...
export default function ForgotPasswordEmailPage({ dark, onToggleDark }) {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-300 ${
      ...
      <Helmet>
        <title>Reset Your Mindleap Password</title>
        <meta name="description" content="Enter your email to receive an OTP code to reset your Mindleap password." />
        <link rel="canonical" href="https://mindleap.live/forgot-password" />
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
          ...
          >
            ...
            <p className={`mt-4 text-base ${dark ? "text-[#B9BEC2]" : "text-[#5C5247]"}`}>
              Enter your email and we will send a one-time code to confirm it is you.
            </p>
