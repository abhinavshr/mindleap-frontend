        ...
        <div className="relative z-10 flex flex-col h-full px-14 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center py-16">
            ...
            <h1 className="text-4xl font-bold text-white leading-tight mb-4">
              Manage your<br />
              <span className="text-blue-400">platform</span> with<br />
              confidence
            </h1>
              ...
              {FEATURES.map((f, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center shrink-0">
                    <span className="text-blue-400 [&>svg]:w-3.5 [&>svg]:h-3.5">{f.icon}</span>
                  </div>
          ...
          <p className="text-xs text-gray-600">
            ...
            &nbsp;·&nbsp;
            <a href="#" className="text-gray-500 hover:text-gray-400 transition">Terms</a>
          </p>
        </div>
      </div>
          ...
          <div className="flex gap-2">
            {ROLES.map((r) => (
              <button
                ...
                className={`flex-1 flex flex-col items-center gap-1.5 py-3 rounded-xl border text-xs font-medium transition
                  ${role === r.key
